<!-- Skill: Design System Adoption | Category: Designer Toolkit -->
<!-- Usage: Include this file as context/system prompt when asking an LLM about design-system-adoption -->
