<!-- Skill: Micro Interaction Spec | Category: Interaction Design -->
<!-- Usage: Include this file as context/system prompt when asking an LLM about micro-interaction-spec -->
