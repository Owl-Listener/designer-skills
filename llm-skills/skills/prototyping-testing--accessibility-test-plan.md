<!-- Skill: Accessibility Test Plan | Category: Prototyping Testing -->
<!-- Usage: Include this file as context/system prompt when asking an LLM about accessibility-test-plan -->
