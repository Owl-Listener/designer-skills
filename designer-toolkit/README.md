# designer-toolkit
Essential designer utilities for writing rationale, building presentations, crafting case studies, UX writing, driving adoption, and generating design briefs.
## Skills (7)
...
- **design-brief** — Generate or regenerate a design brief from existing agent outputs without re-running all agents.
## Commands (4)
...
- `/design:brief` — Generate or regenerate DESIGN-BRIEF.md from existing agent outputs.
